...
var translations = map[string]map[string]string{
	"en": {
		...
		"execution_value":        "SDK + Binary + Shell",
		...
		"field_shell_script":     "Script",
		"field_shell_shell":      "Shell",
		"field_shell_timeout_seconds": "Timeout Seconds",
	...
	"zh": {
		...
		"shell_settings":         "Shell 配置",
		"field_shell_script":     "脚本内容",
		"field_shell_shell":      "解释器",
		"field_shell_timeout_seconds": "超时秒数",
		"dependencies":           "依赖任务",
